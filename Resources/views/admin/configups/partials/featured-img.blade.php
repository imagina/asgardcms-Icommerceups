<div class="featured-img">
  ...
  <div data-preview="#mainimage" data-aspectRatio="0" data-crop="0" class="form-group image col-md-12">
    <div>
    ...
    <div class="row">
      <div class="col-sm-6" style="margin-bottom: 20px;">
        ...
        @if(isset($configuration) && ($configuration!=null) && isset($configuration->options->mainimage))
          <img id="mainImage" src="{{url($configuration->options->mainimage)}}">
        @else
